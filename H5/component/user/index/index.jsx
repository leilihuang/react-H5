...
export default class Detail extends Component {
    ...
    render() {
        const columns = [
            ...
            {title: '会议ID', dataIndex: 'conferenceId', key: 'conferenceId'},
        ...
        return (
            <div className="meeting-box">
                <div className="btn-box">
                    <Button onClick={this.cancelMeet} className="btn-c" inline>取消</Button>
                    <Link to="/create"><Button inline>创建</Button></Link>
                    {this.state.checkboxs.length > 1 ? '' : <Button inline onClick={this.uploadTable}>更新</Button> }
                    <Link to="/search"><Button inline >查询</Button></Link>
                </div>
                <Table
                    columns={columns}
